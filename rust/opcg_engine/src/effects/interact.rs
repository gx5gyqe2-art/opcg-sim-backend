    ...
    match it.kind {
        ...
        InteractionKind::Choice => {
            ...
            if let Some(node) = cont.node.as_ref() {
                let n_options = match node.resolve(super::abilities()) {
        ...
        match frame {
            ...
            DeferredFrame::RemovalTargets {
                ...
                if !remaining.is_empty() {
                    let node = action.resolve(super::abilities()).cloned().ok_or_else(|| {
