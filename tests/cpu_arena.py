...
def play_game(seed: int, db, p1_difficulty: str, p2_difficulty: str,
    ...
    deciders = {"p1": _make_decider(p1_difficulty, _plan_for(p1_difficulty, l1, c1), p1_policy, p1_rng, p1_pimc, p1_alpha, p1_budget, p1_eval_v2, p1_search),
                "p2": _make_decider(p2_difficulty, _plan_for(p2_difficulty, l2, c2), p2_policy, p2_rng, p2_pimc, p2_alpha, p2_budget, p2_eval_v2, p2_search)}
