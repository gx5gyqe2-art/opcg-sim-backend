...
@pytest.mark.xfail(strict=True,
                   reason="OP01-061: 『相手キャラがKOされた時』の誘発トリガー(ON_KO)が欠落し"
                          "YOUR_TURN にすり替わっている。KO 起因の誘発として登録されない。")
...
@pytest.mark.xfail(strict=True,
                   reason="OP01-062: 『イベント発動時』の誘発トリガーが ACTIVATE_MAIN に"
                          "すり替わっている（イベント誘発として登録されない）。")
