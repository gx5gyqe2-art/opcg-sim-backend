...
from legacy.python_engine.core.engine.interaction import choose_selection
...
def test_card_keep_value_ordinal_properties():
    ...
    from legacy.python_engine.core.engine.interaction import card_keep_value as v
