...
from legacy.python_engine.core.cpu_learned import LearnedEngine, _value_fn  # noqa: E402
...
def _init_worker(net, label_sims):
    ...
    from legacy.python_engine.core.cpu_learned import LearnedEngine, _value_fn
...
def main():
    ...
    if args.out and args.shard_rows:
        ...
        try:
            ...
            rev = "?"
        from opcg_sim.learned import config as _cfg
