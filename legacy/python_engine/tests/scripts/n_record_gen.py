...
def _init_worker(sims, value_path, policy_path, n1_net=None,
    ...
    from legacy.python_engine.learned.adapter import OPCGGame as _AG
    from opcg_sim.learned.config import GEN_PRUNE_FUTILE
    db = _load_db()
    ...
    if dump_v2:
        ...
        from opcg_sim.learned import encoder as PE
