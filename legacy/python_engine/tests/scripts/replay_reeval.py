...
from legacy.python_engine.core.gamestate import GameManager, Player, Phase
...
def _board_from_frame(db, rec, fr, actor_pid, actions=None, upto=None):
    ...
    for pid in ("p1", "p2"):
        ...
        from opcg_sim.src.models.journal import JournaledList as _JL
...
def _restore_turn_flags(m, players, actions, upto):
    ...
    from legacy.python_engine.core.engine._helpers import _ability_index, _condition_turn_limit
