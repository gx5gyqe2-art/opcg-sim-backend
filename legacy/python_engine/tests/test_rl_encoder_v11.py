...
（`opcg_sim/learned/leader_feat.py`・能力木→毎ターン率12次元）×2 を足す（97）。
...
from legacy.python_engine.core.cpu_learned import warm_start_value
from opcg_sim.learned.leader_feat import (DIMS, LEADER_FEAT_DIM,
                                              leader_pair_vectors,
