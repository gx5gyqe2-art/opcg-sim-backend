...
from legacy.python_engine.core import cpu_ai, cpu_learned
from legacy.python_engine.core.cpu_learned import LearnedEngine
from opcg_sim.learned import config as C
from legacy.python_engine.learned.mcts import in_battle, in_dialog, resolve_battle_inplace
from legacy.python_engine.learned.plan import move_sig
