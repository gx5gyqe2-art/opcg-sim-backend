...
def test_engine_exit_value_fns_are_neutral_without_heads():
    ...
    from legacy.python_engine.core.cpu_learned import _MODELS, LearnedEngine, _value_fn
...
def test_gen15_pair_is_v12_with_battle_head():
    ...
    from legacy.python_engine.core.cpu_learned import LearnedEngine, _G15_VALUE, _G15_POLICY
    ...
    from legacy.python_engine.core.cpu_learned import _MODELS
...
def test_default_engine_is_nrel_a1_without_exit_head():
    ...
    from legacy.python_engine.core.cpu_learned import LearnedEngine, _C10_VALUE
    eng = LearnedEngine()
...
def test_evaluate_plan_uses_each_head_for_its_own_box(monkeypatch):
    ...
    from legacy.python_engine.learned import plan as PL
    sentinel = object()
    seen_exec = {}
