...
# 上記は SPSA 第2パス（16iter/12games・対照ペア＋コア並列の改善基盤）の best 候補。
# ★【検証中・未確定】SPSA上は best=0.833(Elo+280・ただし12局＝過大評価濃厚)。30ペア(60局・低ノイズ)で
#   検証して優勢を確認できれば確定。互角どまりなら第1パス値(互角・Elo-23)へ戻す。
# 第1パス値（参考）: LIFE_PRECIOUS2.21/HIGH0.80/DECK0.50/DEV0.77/CTR0.33/KAPPA1.0/LAMBDA0.98/BODY0.36/DON0.18。
