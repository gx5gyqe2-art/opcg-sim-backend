...
| アリーナ（主） | r1 vs c10・8 シャード×24 ペア×2 条件・wr≥0.55 かつ CI 下限>0.50（`docs/n_loop_ops.md`）。**r1 実測（2026-09-05）: 主 0.557 [0.503,0.611]／副 0.591 [0.547,0.635]＝2 条件とも達成**（`docs/reports/2026-09-05_r1_judgment.md`）。レイテンシは 2.0 倍で関門未達＝受容はユーザ判断 |
