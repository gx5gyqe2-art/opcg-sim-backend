...
| 生成 波20〜21 | 2201000〜2218000 | 払い出し済み（生成役 c10・era5・2026-09-02 に生成役を差し替え） |
...
| 対照実験 残り起動（腕A2=c10+residual_activate low vs 腕B=c10・紫リーダー×掘り差し込み合成デッキ `--leaders purple --decks synth_dig`・8シャード×24ペア） | 311000〜318000 | 払い出し済み（2026-09-02・判断基準: 全体ペア水準 CI下限>0.50 で「起動は得」・ドン追加リーダー層の局単位勝率で方向確認・規則には入れない。`high` 方針は 321000〜328000 を予約） |
