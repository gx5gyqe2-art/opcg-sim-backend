...
| 検証 c11 vs c10 分散 | ランダム 241000〜248000／ミラー 251000〜258000 | 払い出し済み（2026-09-03・訓練 train-c11: warm c10・π=波20〜22・z=波16〜19→OOM で 17〜19 に縮小（実績・val v_mse 0.6052/v_sign 0.768/pi_top1 0.681・best ep0・n1-results 5f882b0）。評価帯参考値 v_mse（w01+w03 holdout・c8_e2/c10/c11）: 旧帯 波16〜18 0.5615/0.5423/0.5399・新帯 波20〜22 0.6318/0.6214/0.6130＝世代順に単調改善・判断基準 2条件とも wr≥0.55 かつ CI下限>0.50。リーダー入替は従来どおり席のみ＝`cand_leaders` 記録あり） |
