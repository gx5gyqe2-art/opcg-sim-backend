...
| 生成 波21 | 2211000〜2218000 | 払い出し済み（生成役 c10・未実行） |
...
| 検証 c11 vs c10 分散 | ランダム 241000〜248000／ミラー 251000〜258000 | 払い出し済み（2026-09-03・訓練 train-c11: warm c10・π=波20・z=波15〜19・判断基準 2条件とも wr≥0.55 かつ CI下限>0.50。リーダー入替は従来どおり席のみ＝`cand_leaders` 記録あり） |
