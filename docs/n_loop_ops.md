...
| 対照実験 残ドン掘り（腕A=c10+residual_dig vs 腕B=c10・紫リーダー×掘り差し込み合成デッキ `--leaders purple --decks synth_dig`・8シャード×24ペア） | 301000〜308000 | 払い出し済み（2026-09-02・判断基準: 全体ペア水準 CI下限>0.50 で「掘りは得」・層別（ドン追加リーダー/その他）は Wilson で方向を見る・規則には入れない） |
