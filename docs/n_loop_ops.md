...
| 生成 波23〜25（**dump v2**・NRel P4） | 2231000〜2238000／2241000〜2248000／2251000〜2258000 | 払い出し済み（2026-09-04・生成役 c10・`n_record_gen --dump-v2`・コード 0102748 以降。旧形式の波は NRel の教材にならない） |
...
| 検証 次回 | ランダム 281000〜288000／ミラー 291000〜298000 | 予約 |
...
- **dump v2（NRel・2026-09-04〜）**: 生成コマンドに `--dump-v2` を足す（符号化 v13＋トークン状態＋候補の枠 index・
  meta の `dump_version`=2）。生成役・波番号・seed 帯は従来どおり。
