...
| 検証 c10 vs G15 正式（分散・出荷既定切替の確認） | ランダム 261000〜268000／ミラー 271000〜278000 | 払い出し済み（2026-09-03・候補 c10=`neff:`・基準 G15=明示パスの value,policy ペア〔既定が c10 に変わっても基準が動かない〕・8シャード×24ペア×2条件・判断基準 2条件とも wr≥0.55 かつ CI下限>0.50） |
