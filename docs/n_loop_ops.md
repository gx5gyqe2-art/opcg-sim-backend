...
| 生成 波21 | 2211000〜2218000 | 使用済み（2026-09-03 回収・**w02 欠落＝7シャード 6,720局**・棄却5・生成役 c10＝era5。方策一致 w01 で c10 0.678 > c8 0.635） |
| 生成 波22 | 2221000〜2228000 | 使用済み（2026-09-03 回収・**w02 欠落＝7シャード 6,720局**・棄却5・生成役 c10＝era5。方策一致 w01 で c10 0.672 > c8 0.621。波20〜22 は同一 era＝π 窓は3波まとめて使う） |
...
| 検証 c11 vs c10 分散 | ランダム 241000〜248000／ミラー 251000〜258000 | 払い出し済み（2026-09-03・訓練 train-c11: warm c10・π=波20〜22・z=波16〜19（OOM なら 17〜19）・判断基準 2条件とも wr≥0.55 かつ CI下限>0.50。リーダー入替は従来どおり席のみ＝`cand_leaders` 記録あり） |
| 検証 次回 | ランダム 261000〜268000／ミラー 271000〜278000 | 予約 |
